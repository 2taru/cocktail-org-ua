<x-layout doctitle="Питання що часто задаються"
    description="Часто задавані питання (FAQ) про наше програмне забезпечення для ресторанів, барів та кафе. 
    Отримайте відповіді на питання про функціонал, управління меню, складський облік, програмні РРО та підтримку. 
    Знайдіть потрібну інформацію швидко та легко.">
    <!-- Page Content-->
    <section class="py-5">
